...
const translations = {
  en: {
    ...
    'hero.title': 'Cool Comfort, <em>Royal</em> Service.',
    'hero.sub': "Shiraz Empire supplies, installs, maintains and repairs air-conditioning units across Kota Samarahan and greater Kuching — fast response, honest pricing, technicians who treat your home like a palace.",
    'hero.cta1': 'Get a Free Quote', 'hero.cta2': 'Our Services',
    'hero.stat1': 'Core Services', 'hero.stat2': 'Emergency Call-Out',
    'hero.stat3': 'Satisfaction Focus', 'hero.stat4': 'Locally Registered',
    ...
    'about.p2': 'Founded by Mohamad Shahrul Fikrie bin Baduwi, a proud son of Kampung Nakong, Kota Samarahan, Shiraz Empire was built on a simple promise: every home and business deserves cool, clean air — delivered with honesty, punctuality and royal-grade care.',
    ...
    'vm.visionbody': "To be Kota Samarahan's most trusted name in air-conditioning — the first call every home and business makes when they need cool air done right.",
    ...
    'pillar5.title': 'Royal-Grade Care',
    'pillar5.body': 'Every customer is treated like royalty — clean work, polite service, lasting results.',
    ...
    'footer.tagline': 'Cool Comfort, Royal Service — Kota Samarahan, Sarawak.',
  ...
  bm: {
    ...
    'hero.title': 'Keselesaan Sejuk, Servis <em>Bertaraf Diraja</em>.',
    'hero.sub': 'Shiraz Empire membekal, memasang, menyelenggara dan membaik pulih unit penyaman udara di Kota Samarahan dan Kuching — respons pantas, harga jujur, juruteknik yang menjaga rumah anda seperti istana.',
    'hero.cta1': 'Dapatkan Sebut Harga Percuma', 'hero.cta2': 'Perkhidmatan Kami',
    'hero.stat1': 'Perkhidmatan Teras', 'hero.stat2': 'Panggilan Kecemasan',
    'hero.stat3': 'Fokus Kepuasan', 'hero.stat4': 'Berdaftar Tempatan',
    ...
    'about.p2': 'Diasaskan oleh Mohamad Shahrul Fikrie bin Baduwi, anak jati Kampung Nakong, Kota Samarahan, Shiraz Empire dibina atas janji yang ringkas: setiap rumah dan perniagaan layak mendapat udara sejuk dan bersih — disampaikan dengan jujur, tepat masa dan penjagaan bertaraf diraja.',
    ...
    'vm.visionbody': 'Menjadi nama paling dipercayai di Kota Samarahan dalam bidang penyaman udara — panggilan pertama setiap rumah dan perniagaan apabila memerlukan udara sejuk yang dilakukan dengan betul.',
    ...
    'why.eyebrow': 'Kelebihan Kami', 'why.title': 'Kenapa Pilih Empire.',
    ...
    'pillar3.body': 'Janji temu tepat masa dan kerja siap dengan cepat, termasuk panggilan kecemasan.',
    ...
    'pillar5.title': 'Penjagaan Bertaraf Diraja',
    'pillar5.body': 'Setiap pelanggan dilayan seperti raja — kerja bersih, servis sopan, hasil tahan lama.',
    ...
    'footer.tagline': 'Keselesaan Sejuk, Servis Bertaraf Diraja — Kota Samarahan, Sarawak.',
  ...
  zh: {
    ...
    'hero.title': '尊享清凉，<em>皇家</em>服务。',
    'hero.sub': 'Shiraz Empire 为 Kota Samarahan 及古晋一带提供冷气供应、安装、保养与维修服务 — 反应迅速、价格诚实，技师以皇室般的细心呵护您的家。',
    'hero.cta1': '获取免费报价', 'hero.cta2': '查看服务',
    'hero.stat1': '核心服务', 'hero.stat2': '24小时紧急服务',
    'hero.stat3': '专注客户满意度', 'hero.stat4': '本地合法注册',
    ...
    'about.p2': '由 Kota Samarahan Kampung Nakong 土生土长的 Mohamad Shahrul Fikrie bin Baduwi 创立，Shiraz Empire 秉持一个简单的承诺：每个家庭和企业都应享有清凉洁净的空气 — 以诚实、准时与皇家级的用心提供服务。',
    'about.regtitle': '正式注册',
    ...
    'vm.visionbody': '成为 Kota Samarahan 最值得信赖的冷气品牌 — 当家庭与企业需要专业制冷服务时，第一时间想到的就是我们。',
    ...
    'footer.tagline': '尊享清凉，皇家服务 — Kota Samarahan, Sarawak。',
  ...
  ib: {
    ...
    'hero.eyebrow': 'Kota Samarahan — Pakar Penyaman Udara',
    'hero.title': 'Chelap Ti Nyamai, Pengawa <em>Raja</em>.',
    'hero.sub': 'Shiraz Empire nyadi, masang, ngintu enggau ngubah unit penyaman udara di Kota Samarahan enggau Kuching — chepat, betul, jejantan ti ngintu rumah nuan baka istana.',
    'hero.cta1': 'Minta Sebut Reti Percuma', 'hero.cta2': 'Pengawa Kami',
    'hero.stat1': 'Pengawa Pemegai', 'hero.stat2': 'Pengawa Kecemasan',
    'hero.stat3': 'Fokus Pemuas Ati', 'hero.stat4': 'Bedaftar di Endur',
    ...
    'about.p2': 'Dipungka Mohamad Shahrul Fikrie bin Baduwi, anak Kampung Nakong, Kota Samarahan, Shiraz Empire dibengkah atas janji ti mudah: semua rumah enggau pengawa patut bulih udara chelap ti tuchi — diberi enggau bujur, tepat maya, enggau pengawa baka raja.',
    ...
    'vm.visiontitle': 'Visi Kami',
    'vm.visionbody': 'Nyadi nama ti paling dipechaya di Kota Samarahan ke pengawa penyaman udara — penama ti dikenang semua rumah enggau pengawa lebuh diaul chelap.',
    'vm.missiontitle': 'Misi Kami',
    ...
    'why.eyebrow': 'Kenapa Kami', 'why.title': 'Kenapa Pilih Empire.',
    ...
    'pillar3.body': 'Janji temu tepat maya enggau pengawa chepat siap, ngambik kecemasan.',
    'pillar4.title': 'Semua Jenis Dilayan',
    'pillar4.body': 'Kami bekal, masang enggau ngintu semua jenis enggau brand penyaman udara.',
    'pillar5.title': 'Pengawa Baka Raja',
    'pillar5.body': 'Semua pelanggan dilayan baka raja — pengawa tuchi, ramah, asil ti tahan lama.',
    ...
    'footer.tagline': 'Chelap Ti Nyamai, Pengawa Raja — Kota Samarahan, Sarawak.',
